...
parser.add_argument("--data_path", type=str, default='/home/cn/lcr/ast-master/egs/audioset/data/datafiles/train-55-3.json', help="the root path of data json file")

if __name__ == '__main__':
    args = parser.parse_args()
    data_path = args.data_path

    index_dict = make_index_dict('./data/class_labels_ast-3.csv')
